...
-- Safe to re-run: adds preferred_payment for existing waitlist tables.
...
begin
  ...
  insert into public.waitlist (full_name, email, preferred_cohort, preferred_payment)
  values (v_name, v_email, p_preferred_cohort, v_payment)
